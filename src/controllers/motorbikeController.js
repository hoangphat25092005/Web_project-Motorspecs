...
exports.updateMotorbike = async (req, res) => {
    try {
        ...
        const updates = {
            ...
            transmission: req.body.transmission || existingMotorbike.transmission,
            fuelCapacity: req.body.fuelCapacity || existingMotorbike.fuelCapacity,
            year: req.body.year || existingMotorbike.year,
            description: req.body.description || existingMotorbike.description
        };
